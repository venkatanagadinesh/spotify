...
class HttpServer {
  def start(): Unit = {
    ...
    val spotify = new SpotifyClient("BQBY3zMfmRKfU4nqSY0uXZ-FEp2XzqcxiWehLqkNPijW3sGgpNzNUVf38p7ndev0MVhqSEGbXhdyYMN8eS-m7GIOh2dn4ZzocvtaH2u7-DBTQa3zzC7qgTGHF484U8jlUjQKbwLohj2QFkWSRITbr26gABczuZAtCfJRavYIqR6wRtGay5if1G4j6YLZDSAAYxU")
